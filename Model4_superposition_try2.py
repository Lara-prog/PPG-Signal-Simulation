# -*- coding: utf-8 -*-
"""
Created on Sun Apr  6 17:42:45 2025
...
def process_synthetic_signal(pc, pp, ppg_signal, fs=125):
    ...
    pc_filtered = lowpass_filter(pc_randomized, cutoff=6, fs=fs, order=4)
    ...
    pp_filtered = lowpass_filter(pp_randomized, cutoff=6, fs=fs, order=4)
